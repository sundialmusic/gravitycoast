<?php
$to = 'gravitycoast-mailbot@animaltronix.com';
$subject = 'You subject';
$headers = 'From: (GravityCoast.com)' . "\r\n" . 'Content-type: text/html; charset=utf-8';
$message = '
<html>
	<head>
		<title>Contact Gravity Coast</title>
	</head>
	<body>
...
if (!empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['comment'])) {
	if (filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
		mail($to, $subject, $message, $headers) or die('<span class="text-warning">Error sending Mail</span>');
